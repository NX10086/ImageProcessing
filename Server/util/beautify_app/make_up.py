...
class Organ():
    ...
    def whitening(self,rate=0.2,confirm=True):
        '''
        提亮美白
        arguments:
    ...
    def brightening(self,rate=0.2,confirm=True):
        '''
        提升鲜艳度
        arguments:
    ...
    def smooth(self,rate=0.15,ksize=None,confirm=True):
        '''
        磨皮
        arguments:
    ...
    def sharpen(self,rate=0.15,confirm=True):
        '''
        锐化
        '''
...
class Makeup():
    ...
    化妆器
    '''
    def __init__(self,predictor_path=r"G:/Transfer/assets/shape_predictor_68_face_landmarks.dat"):
        self.photo_path=[]
...
def work(path):
	...
	cv2.imwrite('G:/Transfer/tmp/after_make_up.jpg', im.copy())
